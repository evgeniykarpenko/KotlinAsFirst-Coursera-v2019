...
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double =
    (213.36 * sagenes + 71.12 * arshins + vershoks * 4.45) / 100
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val firstYear = (initial / 100.0 * percent) + initial
    val secondYear = (firstYear / 100.0 * percent) + firstYear
    val thirdYear = (secondYear / 100.0 * percent) + secondYear
    return thirdYear
}
